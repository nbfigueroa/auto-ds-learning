...
data_file = pkg_dir + "/SegData-DS/franka_gripper_traj.mat";
load(data_file);
...
for s=1:N_ds
   ...
   %%%%%%%%%%%%%%    Plot GMM of Resulting DS  %%%%%%%%%%%%%%%%%%% 
    ...
    DS_name = strcat('franka_gripper_ds_', num2str(s));
    %     DS_name = strcat('franka_inspection_ds_good_A_', num2str(s));
...
% save_file = pkg_dir + "/models/franka_inspection_sequenceDS_icra22demo_good_A.mat";
save_file = pkg_dir + "/models/franka_gripper_sequenceDS.mat";
...
make_vid = 0;
if make_vid
    vid_name = pkg_dir + "/figs/franka_gripper_sequenceDS_simulation";
