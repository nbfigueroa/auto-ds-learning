...
mat_data_dir = '../../recordings/gripper-prototypes/mat/';
matfile = strcat(mat_data_dir,'demos_gripper1_raw_data_good.mat');
load(matfile);
...
save_file = fileparts(matlab.desktop.editor.getActiveFilename) + "/SegData-DS/franka_gripper_traj.mat";
